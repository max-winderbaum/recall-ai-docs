...
converted_at: "2025-06-10T14:00:11.577Z"
...
The `separate_video_response` schema is defined in the [List Video Separate](/reference/video_separate_list) 200 response
