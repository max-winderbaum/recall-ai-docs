...
converted_at: "2025-06-10T14:00:12.144Z"
api_parameters_count: "0"
---
Sub codes are a field (`sub_code`) added to certain [bot status change](/reference/bot-status-change-events) events to provide extra context.
